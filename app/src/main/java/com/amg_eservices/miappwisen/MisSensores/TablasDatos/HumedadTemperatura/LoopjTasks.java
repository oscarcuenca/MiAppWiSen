            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    for (int i=0; i<temperaturamedia.length(); i++) {
                        ...
                        Temp_media = temperaturasmedias.getString("temperaturasmedias");
                        loopjListener.onLoopjTaskCompleted3(Temp_media);
                    }
                    ...
                    for (int i=0; i<humedadmedia.length(); i++) {
                        ...
                        Humd_media = humedadesmedias.getString("humedadesmedias");
                        loopjListener.onLoopjTaskCompleted8(Humd_media);
                    }
