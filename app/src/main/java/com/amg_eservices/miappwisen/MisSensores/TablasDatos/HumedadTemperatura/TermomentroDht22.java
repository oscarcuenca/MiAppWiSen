 ...
 */
public class TermomentroDht22 extends AppCompatActivity implements OnLoopjCompleted {
    ...
    @Override
    public void onLoopjTaskCompleted3(String Temp_media) {
        String temperatura3 = null;
        temperatura3 = Temp_media.toString();
    ...
    @Override
    public void onLoopjTaskCompleted8(String Humd_media) {
        String humedad3 = null;
        humedad3 = Humd_media.toString();
